...
<script type="text/javascript">
    $(document).ready(function () {
        var id = $("#user_id").val();
        var url = "/jblog/" + id + "/admin/category/getList";
        $.ajax({
            url: url,
            type: "post",
            data: {id: id},
    ...
    function rander(vo) {
        ...
        str += "    <td><img id='"+vo.cateNo+"' src='/assets/images/delete.jpg'></td>"
        str += "</tr>"
    ...
    $("#btnAddCate").on("click",function () {
        ...
        console.log(id);
        $.ajax({
            url:"/jblog/"+id+"/admin/category/insert",
            type:"post",
    ...
    $("#cateList").on("click","img",function () {
        ...
        $.ajax({
            url:"/jblog/"+id+"/admin/category/delete",
            type:"post",
            data:{cateNo:$this},
